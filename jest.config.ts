...
const tsconfig = JSON.parse(fs.readFileSync(path.join(__dirname, 'tsconfig.json'), 'utf-8')) as {
...
const config: Config = {
    ...
    coverageThreshold: {
        ...
        './src/core/lib/crud/crudHelpers.ts': {
            statements: 35,
            branches: 25,
            functions: 45,
            lines: 35,
        },
        './src/core/lib/http/errors/errorHandler.ts': {
            statements: 50,
            branches: 40,
            functions: 65,
            lines: 50,
        },
        './src/core/lib/http/errors/errorCodes.ts': {
            statements: 90,
            branches: 50,
            functions: 50,
            lines: 90,
        },
        './src/core/lib/http/serialization/serializer.ts': {
            statements: 70,
            branches: 65,
            functions: 95,
            lines: 70,

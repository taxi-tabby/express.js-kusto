...
const config = {
  ...
  "inlineSchemaHash": "33a5ece34925bae4d5a820635c1ab9207c6b43c61222ade8938f05fea875b46c",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/app/db/testdb2/client",
    "app/db/testdb2/client",
  ]
...
path.join(process.cwd(), "src/app/db/testdb2/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/app/db/testdb2/client/schema.prisma")

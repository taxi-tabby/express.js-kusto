...
import { Repositories, REPOSITORY_REGISTRY, RepositoryName } from './types/generated-repository-types';
...
export class RepositoryManager {
    ...
    private async loadRepositories(): Promise<void> {
        ...
        for (const repositoryName of repositoryNames) {
            try {
                ...
                const repositoryExports = await repositoryLoader();
     ...
     */
    public getRepository<T extends Repositories>(name: RepositoryName): T {
        if (!this.initialized) {
